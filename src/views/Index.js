        ...
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              This Comprehensive Assessment Management Information System (CA-MIS) has a question bank aligned to 
              Rwanda's competence-based curriculum and a management information system (MIS) that enables teachers in 
              Rwanda to record assessments results, and to monitor student progress.
              </p>
              <div className="mt-12">
                <a
                  href="/auth/login"
